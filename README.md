...
Автономный дрон для инвентаризации склада. Летит по проходу между стеллажами, считывает штрихкоды и возвращается на базу.

**Текущая фаза:** Phase 0 MVP — тюнинг Rack Follower и подготовка к полному циклу сканирования.
